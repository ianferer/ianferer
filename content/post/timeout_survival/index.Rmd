...
```{r timeout histograms, echo = FALSE, fig.hold = 'hold'}
...
```{r all tdc curves, echo = FALSE, message = FALSE, fig.hold = 'hold'}
...
```{r corsi fenwick histograms, echo = FALSE, fig.hold = 'hold'}
